...
set SOURCES=src\main.cpp src\storage.cpp src\report.cpp src\categories.cpp src\tasks.cpp src\demo.cpp src\win32_util.cpp src\screenshot_tool.cpp src\audio_record.cpp src\color_picker.cpp src\data_ops.cpp
